...
echo '<div class="h-100" data-aos="fade-up" data-aos-delay="' . $columnsRepeater . '00">';
...
echo '<div class="position-absolute h-100 bg-accent-quaternary" style="width:99%;top:0;left:0;mix-blend-mode:overlay;opacity:.28;border:2px solid var(--accent-primary);"></div>';

echo '<div class="position-relative pb-3 h-100">';
echo '<span class="h1 d-block cormorant-garamond-light" style="font-size:3.25rem;margin-bottom:1.5rem;">Step ' . $columnsRepeater . '</span>';
